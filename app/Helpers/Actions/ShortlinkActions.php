...
class ShortlinkActions
{
    ...
    public const VISITED_AVAILABLE_PRESEEDED_SHORTLINK = 'VISITED_AVAILABLE_PRESEEDED_SHORTLINK';
    public const VISITED_UNSEEDED_SHORTLINK = 'VISITED_UNSEEDED_SHORTLINK';
    ...
    public const REGISTERED_CUSTOM_SHORTLINK = 'REGISTERED_CUSTOM_SHORTLINK';
